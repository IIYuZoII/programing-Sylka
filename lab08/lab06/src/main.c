 ...
 * @mainpage
 * # Загальне завдання
 * **Створити** функціональну програму, яка буде конвертувати будь-яке число до 9999 включно у слова
 *
 * @author sylkaMichael
 * @date 18-dec-2021
 * @version 1.0
 ...
 * Return тип числа
 *
 * Функція визначає тип числа (цифра, десяток, сотня, цифра)
 * @param x число для перевірки
 * @return тип числа (0 - цифра, 1 - десяток, 2 - сотня, 3 - тисяча)
 */
int x_rank (int x);

/**
 * Функція визначає цифри розрядів 
 * @param x числа виконання розрахунків
 * @param x_is 
 * @param n_num pointers на змінні цифр розрядів
 * @param ten_num
 * @param hun_num 
 * @param thous_num 
 */
 ...
 * Return тип десятка
 *
 * Функція визначає тип десятка (чистий, чистий з цифрою, неправильний)
 * @param n_num цифри для розрахунків
 * @param ten_num 
 * @return тип десятка (0 - чистий, 1 - чистий з цифрою, 2 - неправильний)
 */
 ...
 * 2) Визов функції {@link get_ntht_num} передаваючи {link x}, {link x_is}, та адреса {link n_num}, {link ten_num}, {link hun_num}, {link thous_num}
 * 3) Якщо число Х по розряду не цифра, визов функції {@link get_ten_type} передаваючи {link n_num}, {link ten_num}
 * 4) Запис конвертованого числа у результуючу строк
